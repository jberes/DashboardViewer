import { AfterViewInit, Component, ElementRef, Renderer2, OnDestroy, OnInit, ViewChild } from '@angular/core';
  ...
  private loadDashboardData() {
    this.revealServerService.getDashboardsList().pipe(takeUntil(this.destroy$)).subscribe({
      next: (data) => {
        ...
        if (dashboardId) {
          this.toggleGroup7Visibility();
         
          $.ig.RVDashboard.loadDashboard(dashboardId, (dashboard: any) => {
